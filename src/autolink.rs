...
fn test_md_link() {
    assert_eq!(
        extract_links("[Test](https://google.com)"),
...
fn test_auto_link() {
    assert_eq!(
        extract_links("Hello World https://google.com"),
        vec!["https://google.com"]
    );
}
...
fn test_mixed_links() {
    assert_eq!(
        extract_links("Hello World https://google.com [Test](https://google.de)"),
        vec!["https://google.com", "https://google.de"]
    );
}
